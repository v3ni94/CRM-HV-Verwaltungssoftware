...
import type { BoardEngagementDetail as Detail } from "./types";
...
describe("BoardEngagementDetail", () => {
  ...
  it("sends a question for a position and refreshes", async () => {
    ...
    await waitFor(() => expect(screen.getByText("Die Rückfrage wurde an die Verwaltung übermittelt.")).toBeInTheDocument());
