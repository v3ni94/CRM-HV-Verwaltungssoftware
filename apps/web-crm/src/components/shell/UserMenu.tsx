  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((v) => !v)}
        className="flex h-9 w-9 items-center justify-center rounded-full bg-gold-soft text-sm font-semibold text-fg transition hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-gold/60 focus:ring-offset-2"
      >
        {initials(name)}
      </button>
      {open ? (
        ...
        >
          ...
          <Link
            ...
            role="menuitem"
            className="block rounded-md px-3 py-1.5 text-left text-sm hover:bg-surface"
