...
export const ui = {
  input:
    "w-full rounded-md border border-border bg-bg px-3 py-2 text-sm text-fg placeholder:text-subtle focus:border-gold focus:outline-none focus:ring-2 focus:ring-gold/40",
  ...
  card: "rounded-lg border border-border bg-bg p-5 shadow-card",
  cardLink:
    "block rounded-lg border border-border bg-bg p-5 shadow-card transition hover:border-gold hover:shadow-md focus:outline-none focus:ring-2 focus:ring-gold/40",
